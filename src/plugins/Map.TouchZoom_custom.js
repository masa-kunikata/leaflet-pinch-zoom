...
Map.mergeOptions({
  ...
  // browsers.
  touchZoom_custom: Browser.touch,

  // @option bounceAtZoomLimits: Boolean = true
  // Set it to false if you don't want the map to zoom beyond min/max zoom
  // and then bounce back when pinch-zooming.
  bounceAtZoomLimits_custom: true
});

export const TouchZoom_custom = Handler.extend({
  addHooks() {
  ...
  _onTouchMove(e) {
    ...
    if (!map.options.bounceAtZoomLimits_custom && (
...
// @section Handlers
// @property touchZoom_custom: Handler
// Touch zoom handler.
Map.addInitHook('addHandler', 'touchZoom_custom', TouchZoom_custom);